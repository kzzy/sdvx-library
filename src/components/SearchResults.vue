...
results.value = [
    ...
    },
    {
        ...
        song_artist: "ryhki",
        song_difficulties: [
            <SongDifficulty>{difficulty_name:"NOVICE", difficulty_level:7, difficulty_release_date:"1/1/1969", rank_tier: "D", jacket:"Kakuen_no_valkyria_-Ragnarok-.png"}, 
            <SongDifficulty>{difficulty_name:"ADVANCED", difficulty_level:14, difficulty_release_date:"1/1/1969", jacket:"Kakuen_no_valkyria_-Ragnarok-.png"}, 
            <SongDifficulty>{difficulty_name:"EXHAUST", difficulty_level:17, difficulty_release_date:"1/1/1969", jacket:"Kakuen_no_valkyria_-Ragnarok-.png"},
            <SongDifficulty>{difficulty_name:"MAXIMUM", difficulty_level:19, difficulty_release_date:"1/1/1969", jacket:"Kakuen_no_valkyria_-Ragnarok-.png"}
            ],
        song_release_date: "",
        expanded: false
    },
